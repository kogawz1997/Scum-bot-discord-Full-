...
| 11  | Admin UX polish                       | `Partial`       | `No`                       | Role-based owner/tenant surfaces, quick actions, support toolkits, restart preset guidance, and clearer work areas now exist, but the admin surface is still broad and legacy fallback paths remain.                                                                          |
| 12  | Player portal improvement             | `Partial`       | `No`                       | Wallet, purchases, redeem, profile, Steam link, notification center, order detail drawer, and first-run guidance exist, but broader engagement and long-tail product UX are still open.                                                                                       |
...
| 14  | Documentation polish                  | `Partial`       | `No`                       | The repo now has architecture docs, evidence docs, live captures, quickstart/runbook docs, data-ownership mapping, restart preset docs, and runtime-boundary explainers, but documentation can still be tighter and easier to operate from.                                   |
