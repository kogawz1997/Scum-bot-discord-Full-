(function (root, factory) {
  ...
  function createPlayerCommerceV4Model(source) {
    ...
    return {
      ...
      header: {
        ...
        subtitle: 'ซื้อของ เติมยอด ดูออเดอร์ และติดตามการส่งของจากหน้าเดียวที่เข้าใจง่าย',
        statusChips: [
      ...
      railCards: [
        ...
        },
        {
          ...
          meta: riskyOrders.length > 0 ? riskyOrders[0].purchaseCode || riskyOrders[0].code || '-' : 'หน้าช่วยเหลือจะช่วยสรุปสิ่งที่ต้องเตรียมให้',
  ...
  function buildPlayerCommerceV4Html(model) {
    return [
      ...
      '<p class="plv4-sidebar-copy">ร้านค้า กระเป๋าเงิน คำสั่งซื้อ และการส่งของควรต่อกันเป็นทางเดินเดียว ไม่ใช่หลายหน้าที่ต้องเดาเอง</p>',
      '</div>',
      ...
      '<div class="plv4-panel-head"><div class="plv4-stack"><span class="plv4-section-kicker">ควรทำอะไรต่อ</span><h2 class="plv4-section-title">ไปต่อจากสถานะตอนนี้</h2><p class="plv4-section-copy">เริ่มจากขั้นที่ช่วยให้จบงานเร็วที่สุดก่อน แล้วค่อยเลื่อนลงไปดูรายละเอียดของร้านค้า กระเป๋าเงิน และออเดอร์</p></div></div>',
